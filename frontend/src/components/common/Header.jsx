      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <form onSubmit={handleSearch} className="hidden md:block">
              <div className="relative">
                <input
                  ...
                  className="w-64 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-rose-500 text-white text-sm"
                />
            ...
            {isAuthenticated ? (
              <>
                <button className="p-2 text-gray-300 hover:text-rose-400 relative">
                  <FiBell size={20} />
                  <span className="absolute top-1 right-1 h-2 w-2 bg-rose-500 rounded-full"></span>
                </button>
                
                <div className="flex items-center space-x-3">
                  <div className="h-8 w-8 rounded-full bg-gradient-to-r from-rose-600 to-red-600 flex items-center justify-center text-white font-semibold text-sm">
              ...
              <div className="flex items-center space-x-3">
                <Link
                  to="/login"
                  className="text-gray-300 hover:text-rose-400 text-sm font-medium"
                >
                  Sign in
                </Link>
                <Link
              ...
              {!isAuthenticated && (
                <div className="pt-4 border-t border-gray-800 space-y-2">
                  ...
                  <Link
                    to="/register"
                    onClick={() => setMobileMenuOpen(false)}
                    className="block px-4 py-3 text-center bg-gradient-to-r from-rose-600 to-red-600 hover:from-rose-700 hover:to-red-700 text-white font-medium rounded-lg"
                  >
                    Sign up
                  </Link>
                </div>
