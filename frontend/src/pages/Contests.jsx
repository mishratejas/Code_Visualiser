...
const Contests = () => {
  ...
  const handlePasswordSubmit = (e) => {
    ...
    registerForContest(
      selectedContest.id || selectedContest._id,
      contestPassword,
    );
  };
  ...
  const filteredContests = contests.filter((contest) => {
    ...
    const matchesFilter =
      filter === "all" || getContestStatus(contest) === filter;
  ...
  return (
    <div className="space-y-8">
      ...
      {filteredContests.length > 0 &&
        getContestStatus(filteredContests[0]) === "upcoming" && (
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-6 mb-6">
                    <div className="flex items-center gap-2 text-gray-300">
                      ...
                      <span>
                        {safeFormat(
                          filteredContests[0].startTime ||
                            filteredContests[0].start_time,
                          "MMM dd, yyyy • hh:mm a",
                        )}
                      </span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-300">
                      ...
                      <span>
                        {filteredContests[0].duration ||
                          filteredContests[0].duration_minutes}{" "}
                        minutes
                      </span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-300">
                      ...
                      <span>
                        {filteredContests[0].participants?.length ||
                          filteredContests[0].participantsCount ||
                          0}{" "}
                        registered
                      </span>
                    </div>
                  ...
                  <ContestTimer
                    ...
                    endTime={
                      filteredContests[0].endTime ||
                      filteredContests[0].end_time
                    }
                    size="large"
                    showLabels={true}
                  />
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex items-center text-gray-300">
                      ...
                      <span className="text-sm">
                        {contest.duration || contest.duration_minutes} minutes
                      </span>
                    </div>
                    <div className="flex items-center text-gray-300">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700 shadow-2xl max-w-md w-full p-8 animate-in fade-in zoom-in duration-200">
            ...
            <div className="mt-6 p-4 bg-blue-500/10 rounded-xl border border-blue-500/30">
              ...
              <p className="text-xs text-gray-400 text-center mt-1">
                {safeFormat(
                  selectedContest.startTime || selectedContest.start_time,
                  "MMM dd, yyyy • hh:mm a",
                )}
              </p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-blue-600/10 to-cyan-600/10 rounded-2xl border border-blue-500/30 p-6">
          ...
          <p className="text-gray-300 text-sm">
            Win cash prizes, certificates, and premium subscriptions by
        ...
        <div className="bg-gradient-to-br from-green-600/10 to-emerald-600/10 rounded-2xl border border-green-500/30 p-6">
          ...
          <p className="text-gray-300 text-sm">
            Compete with top coders worldwide and enhance your problem-solving
        ...
        <div className="bg-gradient-to-br from-purple-600/10 to-pink-600/10 rounded-2xl border border-purple-500/30 p-6">
          ...
          <p className="text-gray-300 text-sm">
            Get ranked globally and showcase your achievements to recruiters and
      ...
      <div className="relative overflow-hidden rounded-3xl">
        ...
        <div className="relative z-10 bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl rounded-3xl border border-gray-700/50 p-8 text-center">
          ...
          <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
            Join thousands of developers in our coding contests. Test your
            skills, learn from others, and climb the global leaderboard.
          </p>
