...
const SimilarityBar = ({ value, label }) => {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-xs font-mono font-bold text-gray-900 dark:text-white w-10 text-right">{pctVal}%</span>
    </div>
  );
};
...
const PlagiarismPanel = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-50 dark:from-gray-900 to-white dark:to-black">
        <div className="text-center">
          <Loader />
          <p className="text-gray-500 dark:text-gray-400 mt-4 animate-pulse">Loading plagiarism data…</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 dark:from-gray-900 to-white dark:to-black text-gray-900 dark:text-white">
      ...
      {/* ── Header bar ── */}
      <div className="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/60 backdrop-blur-xl sticky top-0 z-40">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">{contest?.title || `Contest #${contestId}`}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={checking}
              className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-red-600 to-orange-600 text-gray-900 dark:text-white rounded-xl hover:shadow-lg hover:shadow-red-500/20 transition-all font-medium disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {checking ? (
      ...
      <div className="container mx-auto px-6 py-8 space-y-8">
        ...
        {!report && !loading && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            <div className="w-24 h-24 bg-gray-100 dark:bg-gray-800/50 rounded-2xl flex items-center justify-center mb-6 border border-gray-300 dark:border-gray-700/50">
              <FiShield className="h-12 w-12 text-gray-600 dark:text-gray-500" />
            </div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">No Report Yet</h2>
            <p className="text-gray-500 dark:text-gray-400 max-w-md mb-3">
              No plagiarism analysis has been run for this contest yet.
            </p>
            <p className="text-gray-600 dark:text-gray-500 text-sm max-w-md mb-8">
              Reports are generated <strong className="text-gray-500 dark:text-gray-400">automatically</strong> when a contest ends.
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={fetchData}
                className="flex items-center gap-2 px-5 py-2.5 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-600 transition-all font-medium"
              >
                <FiRefreshCw className="h-4 w-4" />
                Refresh
              </button>
              <button
                onClick={handleRunCheck}
                disabled={checking}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-red-600 to-orange-600 text-gray-900 dark:text-white rounded-xl hover:shadow-lg transition-all font-semibold disabled:opacity-60"
              >
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div
                  key={label}
                  className={`bg-gray-100 dark:bg-gray-800/40 border border-gray-300 dark:border-gray-700/50 rounded-2xl p-5 text-center hover:border-${color}-500/40 transition-colors`}
                >
            ...
            {/* ── Report meta ── */}
            <div className="bg-gray-100 dark:bg-gray-800/30 border border-gray-300 dark:border-gray-700/50 rounded-2xl p-5 flex flex-wrap gap-6 text-sm text-gray-500 dark:text-gray-400">
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-900 dark:text-white font-medium">{report.totalSubmissions ?? "—"}</span>
              </div>
              <div className="flex items-center gap-2">
                <FiPercent className="h-4 w-4" />
                Avg similarity:{" "}
                <span className="text-gray-900 dark:text-white font-medium">{pct(report.averageSimilarity)}</span>
              </div>
              <div className="flex items-center gap-2">
                <FiShield className="h-4 w-4" />
                Threshold:{" "}
                <span className="text-gray-900 dark:text-white font-medium">{pct(report.threshold)}</span>
              </div>
            </div>

            {/* ── Filters + search ── */}
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex bg-gray-100 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700/50 rounded-xl p-1 gap-1 flex-wrap">
                {[
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                      filter === key
                        ? "bg-gradient-to-r from-red-600 to-orange-600 text-gray-900 dark:text-white shadow-lg"
              ...
              <div className="flex-1 min-w-[200px]">
                <div className="relative">
                  <FiSearch className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-600 dark:text-gray-500" />
                  <input
                    type="text"
                    placeholder="Search by username…"
                    value={search}
                    onChange={(e) => setSearch(e.target.value)}
                    className="w-full pl-9 pr-4 py-2.5 bg-gray-100 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700/50 rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-red-500/50"
                  />
                </div>
              </div>
            </div>
            ...
            {filteredPairs.length === 0 ? (
              <div className="text-center py-16 text-gray-500 dark:text-gray-400">
                ...
                <p className="text-lg font-medium text-gray-900 dark:text-white">No pairs match this filter</p>
              ...
              <div className="space-y-3">
                {filteredPairs.map((pair, idx) => {
                  ...
                  const scoreColor =
                    ...
                    score >= 60 ? "text-yellow-400" : "text-blue-400";

                  return (
                    <div
                      key={idx}
                      className={`bg-gray-100 dark:bg-gray-800/40 border rounded-2xl p-5 hover:border-gray-400 dark:hover:border-gray-600/60 transition-all ${
                        isLowConfidence ? 'border-blue-400/40 dark:border-blue-500/30' : 'border-gray-300 dark:border-gray-700/50'
                      }`}
                    >
                      {isLowConfidence && (
                        <div className="mb-3 flex items-center gap-1.5 text-xs font-bold text-blue-500 dark:text-blue-400">
                          <FiSearch className="h-3.5 w-3.5" />
                          Below auto-flag threshold — surfaced for manual review, not an automatic accusation
                        </div>
                      )}
                      <div className="flex flex-wrap items-center justify-between gap-4">
                        {/* Users */}
                        <div className="flex items-center gap-4">
                          <div className="flex items-center gap-2 bg-white dark:bg-gray-900/50 px-3 py-2 rounded-xl border border-gray-300 dark:border-gray-700/40">
                            <FiUser className="h-4 w-4 text-blue-400" />
                            <span className="text-sm font-medium text-gray-900 dark:text-white">
                              {pair.user1?.username || pair.user1?.toString?.().slice(0, 8) || "User 1"}
                            </span>
                          </div>
                          <span className="text-gray-600 dark:text-gray-500 text-xs font-bold">VS</span>
                          <div className="flex items-center gap-2 bg-white dark:bg-gray-900/50 px-3 py-2 rounded-xl border border-gray-300 dark:border-gray-700/40">
                        ...
                        <div className="flex items-center gap-4">
                          <div className="text-center">
                            ...
                            <div className="text-xs text-gray-600 dark:text-gray-500">similarity</div>
                          </div>
                      ...
                      {pair.verdict === "pending" && (
                        <div className="mt-4 flex flex-wrap gap-2 pt-4 border-t border-gray-300 dark:border-gray-700/40">
                          <button
                            onClick={() => setSelectedPair({ pair, idx })}
                            className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-700/50 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors text-sm font-medium"
                          >
                      ...
                      {/* Reviewed info */}
                      {pair.verdict !== "pending" && (
                        <div className="mt-4 pt-4 border-t border-gray-300 dark:border-gray-700/40 space-y-2">
                          ...
                          {pair.reviewNotes && (
                            <p className="text-sm text-gray-500 dark:text-gray-400 italic">Notes: {pair.reviewNotes}</p>
                          )}
                        </div>
                      )}
                    </div>
      ...
      {selectedPair && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white dark:bg-black/70 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700/60 rounded-2xl w-full max-w-lg shadow-2xl">
            <div className="flex items-center justify-between p-6 border-b border-gray-300 dark:border-gray-700/50">
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="flex items-center justify-around">
                ...
                <div className="text-2xl font-black text-gray-600 dark:text-gray-500">VS</div>
                <div className="text-center">
              ...
              {/* Similarity scores */}
              <div className="space-y-2 bg-gray-100 dark:bg-gray-800/40 rounded-xl p-4">
              ...
              {/* Notes */}
              <div>
                <label className="block text-sm text-gray-500 dark:text-gray-400 mb-2">Review Notes (optional)</label>
                <textarea
                  value={reviewNotes}
                  onChange={(e) => setReviewNotes(e.target.value)}
                  rows={3}
                  placeholder="Add notes about your decision…"
                  className="w-full px-4 py-3 bg-gray-100 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700/50 rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-red-500/50 resize-none"
                />
              </div>
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-red-600 to-rose-600 text-gray-900 dark:text-white rounded-xl hover:shadow-lg hover:shadow-red-500/20 transition-all font-semibold"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-gray-900 dark:text-white rounded-xl hover:shadow-lg hover:shadow-green-500/20 transition-all font-semibold"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-gray-900 dark:text-white rounded-xl hover:shadow-lg hover:shadow-blue-500/20 transition-all font-semibold"
                >
