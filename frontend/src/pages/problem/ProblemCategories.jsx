...
const CATEGORY_META = {
  ...
  'bfs':                 { label: 'BFS',                  icon: '🌊', description: 'Breadth-first search traversal',        color: 'from-cyan-600 to-teal-500' },
  'dfs':                 { label: 'DFS',                  icon: '🧭', description: 'Depth-first search traversal',          color: 'from-teal-600 to-cyan-500' },
  'trie':                { label: 'Trie',                 icon: '🌲', description: 'Prefix tree problems',                  color: 'from-lime-600 to-green-600' },
  'lcs':                 { label: 'LCS',                  icon: '🧬', description: 'Longest common subsequence problems',   color: 'from-purple-600 to-violet-500' },
  'knapsack':            { label: 'Knapsack',             icon: '🎒', description: 'Knapsack-style DP problems',            color: 'from-amber-600 to-orange-600' },
  'matrix-dp':           { label: 'Matrix DP',            icon: '🔲', description: 'Grid-based dynamic programming',        color: 'from-indigo-600 to-blue-600' },
  'bitmask-dp':          { label: 'Bitmask DP',           icon: '🎭', description: 'DP over subsets using bitmasks',        color: 'from-slate-600 to-gray-600' },
  'intervals':           { label: 'Intervals',            icon: '📏', description: 'Interval merging and scheduling',       color: 'from-rose-600 to-pink-600' },
  'binary-search-tree':  { label: 'Binary Search Tree',   icon: '🌴', description: 'BST validation and operations',         color: 'from-emerald-600 to-teal-600' },
};
