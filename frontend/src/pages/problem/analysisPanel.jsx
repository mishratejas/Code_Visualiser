...
const ScoreBar = ({ label, value, max = 100, color = 'bg-purple-500' }) => (
  <div>
    <div className="flex justify-between items-center mb-1">
      ...
      <span className="text-xs font-bold text-gray-900 dark:text-white">{value}{max === 100 ? '%' : `/${max}`}</span>
    </div>
...
export default function AnalysisPanel({
  ...
  /* ── Loading ──────────────────────────────────────────────────────────── */
  if (isLoading) return (
    <div className="flex flex-col items-center justify-center p-12 gap-4 text-gray-500 dark:text-gray-400 min-h-[300px]">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-500 mt-1">This may take 5–15 seconds</p>
      </div>
    </div>
  );
  ...
  if (!analysis) return (
    <div className="p-8 text-center">
      ...
      <h3 className="text-gray-900 dark:text-white font-bold text-lg mb-2">AI Code Analysis</h3>
      <p className="text-gray-500 dark:text-gray-400 text-sm mb-2">Get detailed Gemini-powered analysis:</p>
      <ul className="text-xs text-gray-600 dark:text-gray-500 mb-6 space-y-1">
      ...
      {errMsg && (
        <div className="mb-4 px-4 py-3 bg-red-900/30 border border-red-500/30 text-red-400 text-xs rounded-xl space-y-1">
          ...
          <p className="text-gray-500 dark:text-gray-400">{errMsg}</p>
          {errMsg.includes('offline') && (
            <div className="mt-2 bg-white dark:bg-gray-900 rounded-lg px-3 py-2 font-mono text-xs text-green-400 border border-gray-300 dark:border-gray-700">
      ...
      <button
        ...
        className="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-gray-900 dark:text-white font-bold rounded-xl transition-all shadow-lg shadow-purple-500/20 flex items-center gap-2 mx-auto"
      >
    ...
    <div className="p-5 space-y-5 text-sm overflow-y-auto">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-xs text-gray-600 dark:text-gray-500 hover:text-purple-400 transition-colors flex items-center gap-1"
        >
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-gray-100 dark:bg-gray-800/60 rounded-xl p-4 border border-gray-300 dark:border-gray-700/50">
          ...
          <div className="text-gray-900 dark:text-white font-mono font-bold text-base">
      ...
      {/* Quality */}
      <div className="bg-gray-100 dark:bg-gray-800/60 rounded-xl p-4 border border-gray-300 dark:border-gray-700/50 space-y-3">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 space-y-2">
            ...
            {analysis.performance_rating && (
              <div className="flex items-center gap-2">
                <span className="text-xs text-gray-600 dark:text-gray-500">Performance:</span>
            ...
            {analysis.algorithm_detected && (
              <div className="flex items-center gap-2">
                <span className="text-xs text-gray-600 dark:text-gray-500">Algorithm:</span>
        ...
        <div className={`rounded-xl p-3 border ${testCasesPassed === totalTestCases ? 'bg-green-900/20 border-green-500/20' : 'bg-red-900/20 border-red-500/20'}`}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-gray-600 dark:text-gray-300">Test Cases</span>
            </div>
          ...
          {runtimeMs > 0 && (
            <div className="flex items-center gap-1 mt-1 text-xs text-gray-600 dark:text-gray-500">
      ...
      {Object.keys(m).length > 0 && (
        <div className="bg-gray-100 dark:bg-gray-800/60 rounded-xl p-4 border border-gray-300 dark:border-gray-700/50">
          <button className="flex items-center justify-between w-full" onClick={() => toggleSection('metrics')}>
            ...
            {expandedSection === 'metrics' ? <ChevronUp className="w-4 h-4 text-gray-600 dark:text-gray-500" /> : <ChevronDown className="w-4 h-4 text-gray-600 dark:text-gray-500" />}
          </button>
            ...
            <div className="mt-3 space-y-2">
              <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 text-xs">
                {[
                  ...
                  <div key={label} className="flex justify-between border-b border-gray-300 dark:border-gray-700/30 pb-1">
                    <span className="text-gray-600 dark:text-gray-500">{label}</span>
                    <span className="text-gray-600 dark:text-gray-300 font-mono">{val}</span>
                  </div>
                ))}
              </div>
      ...
      {analysis.bottleneck_analysis?.length > 0 && (
        <div className="bg-gray-100 dark:bg-gray-800/60 rounded-xl p-4 border border-gray-300 dark:border-gray-700/50">
          <button className="flex items-center justify-between w-full" onClick={() => toggleSection('bottleneck')}>
            ...
            {expandedSection === 'bottleneck' ? <ChevronUp className="w-4 h-4 text-gray-600 dark:text-gray-500" /> : <ChevronDown className="w-4 h-4 text-gray-600 dark:text-gray-500" />}
          </button>
      ...
      {analysis.explanation && (
        <div className={`rounded-xl p-4 border ${q.bg} ${q.border}`}>
          ...
          <p className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed">{analysis.explanation}</p>
        </div>
      )}
    </div>
  );
