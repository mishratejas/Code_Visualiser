...
const CodeModal = ({ submission, onClose }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-white dark:bg-black/60 backdrop-blur-sm p-4"
      onClick={onClose}
    >
      <div
        className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden border border-gray-300 dark:border-gray-700"
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-300 dark:border-gray-700">
          <div>
            ...
            <div className="flex items-center gap-3 mt-1">
              <span className="text-xs text-gray-500 dark:text-gray-400">{submission.language}</span>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={copyCode}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 text-sm rounded-lg transition"
            >
              <FiCopy size={14} /> Copy
            </button>
            <button
              onClick={onClose}
              className="p-1.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 rounded-lg transition"
            >
              <FiX size={18} />
            </button>
          </div>
        ...
        <div className="flex-1 overflow-auto p-5">
          {submission.code ? (
            <pre className="text-sm text-gray-700 dark:text-gray-200 font-mono leading-relaxed whitespace-pre-wrap break-words">
              {submission.code}
            </pre>
          ) : (
        ...
        {/* Stats Footer */}
        <div className="flex items-center gap-6 px-5 py-3 bg-gray-100 dark:bg-gray-800/60 border-t border-gray-300 dark:border-gray-700 text-xs text-gray-500 dark:text-gray-400">
          <span>Runtime: <span className="text-gray-900 dark:text-white">{submission.executionTime || submission.runtime || 0} ms</span></span>
          <span>Memory: <span className="text-gray-900 dark:text-white">{submission.memoryUsed || submission.memory || 0} KB</span></span>
          {submission.passedTestCases != null && (
            <span>Tests: <span className="text-gray-900 dark:text-white">{submission.passedTestCases}/{submission.totalTestCases}</span></span>
          )}
        </div>
      </div>
    </div>
...
const Submissions = () => {
  ...
  const statusOptions = [
    ...
    { value: 'compilation_error', label: 'Compilation Error', icon: FiCode, color: 'text-gray-600 dark:text-gray-500' },
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center px-4 py-2 bg-gray-100 dark:bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-200 dark:hover:bg-gray-700 self-start"
        >
      ...
      {/* Filters Panel */}
      {showFilters && (
        <div className="bg-white dark:bg-gray-100 dark:bg-gray-800 rounded-xl shadow-lg p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 bg-gray-50 dark:bg-gray-200 dark:bg-gray-700 border border-gray-300 dark:border-gray-400 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:text-gray-900 dark:text-white"
              >
          ...
          {/* Filter Actions */}
          <div className="flex justify-between items-center pt-4 border-t border-gray-200 dark:border-gray-300 dark:border-gray-700">
            <button
              onClick={handleResetFilters}
              className="px-4 py-2 text-gray-600 dark:text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-900 dark:hover:text-white"
            >
              Reset all filters
            </button>
            <button
              onClick={() => setShowFilters(false)}
              className="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-gray-900 dark:text-white rounded-lg hover:opacity-90"
            >
              Apply Filters
            </button>
          </div>
      ...
      {/* Submissions List */}
      <div className="bg-white dark:bg-gray-100 dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
        {/* Table Header */}
        <div className="grid grid-cols-12 gap-4 px-6 py-4 bg-gray-50 dark:bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-300 dark:border-gray-700">
          <div className="col-span-2 text-sm font-medium text-gray-600 dark:text-gray-500 dark:text-gray-400">
            Status
          </div>
          <div className="col-span-4 text-sm font-medium text-gray-600 dark:text-gray-500 dark:text-gray-400">
            Problem
          </div>
          <div className="col-span-2 text-sm font-medium text-gray-600 dark:text-gray-500 dark:text-gray-400">
            Language
        ...
        {submissions.length > 0 ? (
          <div className="divide-y divide-gray-200 dark:divide-gray-300 dark:divide-gray-700">
    ...
    >
      ...
      <div className="col-span-4">
        <Link
          ...
          className="font-medium text-gray-900 dark:text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition"
        >
          {submission.problem?.title || 'Unknown Problem'}
        </Link>
        <div className="text-sm text-gray-600 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 mt-1">
          {new Date(submission.submittedAt || submission.createdAt || Date.now()).toLocaleString()}
        </div>
      </div>
      <div className="col-span-2">
        <div className="flex items-center">
          <FiCode className="mr-2 text-gray-500 dark:text-gray-400" />
      ...
      <div className="col-span-2">
        <div className="flex items-center">
          <FiCpu className="mr-2 text-gray-500 dark:text-gray-400" />
          <span className="text-gray-700 dark:text-gray-600 dark:text-gray-300">
      ...
      <div className="col-span-2 flex items-center justify-between">
        ...
        <button
          ...
          className="p-1.5 text-gray-500 dark:text-gray-400 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition"
          title="View Code"
        >
          <FiEye size={15} />
        </button>
          ...
          <div className="text-center py-12">
            <div className="text-gray-500 dark:text-gray-400 dark:text-gray-600 dark:text-gray-500 text-6xl mb-4">📝</div>
            <h3 className="text-xl font-medium text-gray-900 dark:text-gray-900 dark:text-white mb-2">
              No submissions yet
            </h3>
            <p className="text-gray-600 dark:text-gray-500 dark:text-gray-400 mb-6">
        ...
        {submissions.length > 0 && totalPages > 1 && (
          <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-300 dark:border-gray-700">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  disabled={page === 1}
                  className="px-3 py-1 bg-gray-100 dark:bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-600 dark:text-gray-300 rounded hover:bg-gray-200 dark:hover:bg-gray-300 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Previous
                </button>
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1 rounded ${page === pageNum
                          ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-gray-900 dark:text-white'
                          : 'bg-gray-100 dark:bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-300 dark:hover:bg-gray-600'
                        }`}
                    >
                      {pageNum}
                    </button>
